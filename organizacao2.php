			...
			<div class="inside">
				...
				<div class="inside1">
					<div class="wrap row-2">
						...
						<article class="col-2">
							<h2>Comissão Organizadora</h2></br>
							<div class="img-box"><img src="images/comite2.png">Prof. Dr. Marco Antônio Piteri</br>Prof. Dr. Almir Olivette Artero</br>Prof. Dr. Celso Olivete Júnior</br>Prof. Dr. Danilo Medeiros Eler</br>Prof. Dr. Milton Hirokazu Shimabukuro</br></div>
						</article>
						<div class="clear"></div>
					</div>
				</div>
