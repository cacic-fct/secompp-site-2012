	...
	?>	
				...
				<table style="margin: 0px 0px 0px 44px; -moz-border-radius: 225px;" width="900" cellpadding="4" cellspacing="4" >
					...
					<tr>
						...
						<td bgcolor="#d9d9d9" ><br /><font style="font-size :16px;"><b>Palestra:</b></font> <a href="palestras2.php" style="text-decoration:none">Tendências e Perspectivas no Desenvolvimento e Utilização de Recursos Educacionais Abertos</a><br /><br /></td>
					</tr>
				</table>
