<?php
	$query = "SELECT u.usr_id as codigo, dad_nome as nome FROM usuario u, dados d WHERE d.usr_id = u.usr_id ORDER BY dad_nome;"; //Alias usados pra adaptar ao ano anterior
