...
<div class="tail-top1">
	...
	$mc6 = "<a href=\"minicursos5.php\" style=\"text-decoration:none\">- Introdução à Programação para Android (Sala 10/Discente I)</a></br>";
	...
	?>	
				...
				<table style="margin: 0px 0px 0px 44px; -moz-border-radius: 225px;" width="900" cellpadding="4" cellspacing="4" >
					...
					<tr>
						...
						<td bgcolor="#d9d9d9" ><br /><font style="font-size :16px;"><b>Palestra:</b></font> <a href="palestras1.php" style="text-decoration:none">Telecomunicações e TI a Convergência gerando oportunidades</a><br /><br /></td>
					</tr>
				</table>
