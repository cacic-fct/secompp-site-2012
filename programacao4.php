	...
	?>	
				...
				<table style="margin: 0px 0px 0px 44px; -moz-border-radius: 225px;" width="900" cellpadding="4" cellspacing="4" >
					...
					<tr>
						...
						<td bgcolor="#d9d9d9"><br /><?php echo $mc5; ?><br /></td>
					</tr>
					...
					<tr>
						...
						<td bgcolor="#d9d9d9"><br /><?php echo $mc5; ?><br /> <font style="font-size :16px;"><b>Palestra:</b></font> <a href="palestra4s.php" style="text-decoration:none">Recrutamento e Seleção - Aspectos relevantes no processo seletivo</a><br /><br /></td>
					</tr>
					...
					<tr>
						...
						<td bgcolor="#d9d9d9"><br /><?php echo $mc1 . $mc4 . $mc11; ?><br /></td>
					</tr>
					...
					<tr>
						<td bgcolor="#d9d9d9"  align="center"><br />18h30<br /><br /></td>
						<td bgcolor="#d9d9d9"><br /><a href="tcc.php" style="text-decoration:none">Mostra de TCCs</a><br /></td>
					</tr>
					
					<tr>
						<td bgcolor="#FFFFFF"  align="center"><br />19h30<br /><br /></td>
						<td bgcolor="#FFFFFF" ><br /><a href="mesaredonda.php" style="text-decoration:none"><font style="font-size :16px;"><b>Mesa-Redonda</b></font></a><br /><br /></td>
					</tr>
				</table>
