			...
			<div class="inside">
				...
				<div class="inside1">
					<div class="wrap row-2">
						...
						<article class="col-2">
							<h2>Conselho de Curso</h2></br>
							<div class="img-box"><img src="images/comite1.png">
								Prof. Dr. Ronaldo Celso Messias Correia</br>
								Prof. Dr. Celso Olivete Júnior</br>
								Prof. Dr. Marco Antônio Piteri</br>
								Prof. Dr. Milton Hirokazu Shimabukuro</br>
								Prof. Dr. Rogério Eduardo Garcia</br>
								Prof. Dr. Maurício Araújo Dias</br>
